...
$toEmail = "vincentvck8@gmail.com"; // Replace Your Email Address
...
$fromEmail = "vincentvck8@gmail.com";  // Replace Company's Email Address (preferably currently used Domain Name)
$fromName = "Vincent Verdonck"; // Replace Company Name
...
/* --------------------------------------------
  // Subject
--------------------------------------------- */
$subject = "Your Request"; // Your Subject
